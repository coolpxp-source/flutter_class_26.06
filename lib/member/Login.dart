...
import 'package:project1/member/SchedulePage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> login() async {
    ...
    final querySnapshot = await fs.collection('member')
    ...
    if (querySnapshot.docs.isEmpty) {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => SchedulePage(memberDocId: querySnapshot.docs.first.id ))
      );
    }
  }
